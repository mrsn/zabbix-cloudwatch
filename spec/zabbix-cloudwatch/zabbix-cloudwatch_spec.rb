  ...
  describe GetCloudwatchMetric do
    describe '#new' do
      it 'Raises NamespaceArgumentMissingException when options are empty' do
        -> { ZabbixCloudwatch::GetCloudwatchMetric.new }.should raise_error GetCloudwatchMetric::NamespaceArgumentMissingException
      end
      it 'Raises NamespaceArgumentMissingException when there is no namespace key in the options' do
        options = {}
        -> { ZabbixCloudwatch::GetCloudwatchMetric.new(options) }.should raise_error GetCloudwatchMetric::NamespaceArgumentMissingException
      end
      it 'Raises MetricnameArgumentMissingException when there is no metricname key in the options' do
        options = { 'namespace' => '' }
        -> { ZabbixCloudwatch::GetCloudwatchMetric.new(options) }.should raise_error GetCloudwatchMetric::MetricnameArgumentMissingException
      end
      it 'Raises DimensionArgumentMissingException when both dimension keys are not in the options' do
        ...
        -> { ZabbixCloudwatch::GetCloudwatchMetric.new(options) }.should raise_error GetCloudwatchMetric::DimensionArgumentMissingException
      ...
      it 'Raises Exception when aws keys are not in options' do
        ...
        -> { ZabbixCloudwatch::GetCloudwatchMetric.new(options) }.should raise_error GetCloudwatchMetric::AwsAccessKeyMissingException
        options = { 'namespace' => '', 'metricname' => '', 'dimension-value' => '', 'dimension-name' => '', 'aws-access-key' => '' }
        -> { ZabbixCloudwatch::GetCloudwatchMetric.new(options) }.should raise_error GetCloudwatchMetric::AwsSecretKeyMissingException
      end
    end
